...
public class Calculator {
    public static void main(String[] args) {
        ...
        // List<String> history = new ArrayList<>(); // ArrayList로 계산 기록 저장
        //----- 여기에 로직을 작성하세요. ----
        Map<Integer, String> history = new HashMap<>(); // HashMap으로 계산 기록 저장
        int historyKey = 1; // Key는 1부터 시작
        // -- END --
        ...
        //----- 여기에 로직을 작성하세요. ----
        System.out.println("\n=== 계산 기록 ===");
        Iterator<Map.Entry<Integer, String>> iterator = history.entrySet().iterator();
        while (iterator.hasNext()) {
